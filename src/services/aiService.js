...
Сделай это нативно, объяснив почему это круто: "${matrix.cross_sell_description || 'Вам точно понравится!'}"`;
    ...
    prompt += `\n\nСТРОГОЕ ПРАВИЛО: Никогда не проси клиента писать в личные сообщения, мессенджеры или звонить. Это запрещено правилами Wildberries и ведет к блокировке. Предлагай решать вопросы через официальный раздел "Вопросы" или "Чат с продавцом" на самой платформе.`;
